...
def main():
    s = input('Введите сообщение: ')  # читаем строку длиной  до 10**4
    ...
    print('Число символов: ', len(code), '\nДлина закодированного сообщения: ', len(encoded))  # выведем число символов и длину закодированной строки
    print('Символ | Его код:')
